...
vectors:
        b 	_start      	; reset                    (0x00)
        b	_start       	; undefined instruction    (0x04)
        b	_start       	; software interrupt (SWI) (0x08)
        b	_start       	; prefetch abort           (0x0C)
        b	_start       	; data abort               (0x10)
        b	_start       	; checksum                 (0x14)
        b	_start    	; IRQ                      (0x18)
	b	_start  	; FIRQ                     (0x1C)
...
;;;; label LSHIFT is Forth word LSHIFT ( a b - a*2^b )
LSHIFT:	
	dpop r1
	mov TOS, r1, lsl TOS
	nxt

;;;; label RSHIFT is Forth word RSHIFT ( a b - a/2^b )
RSHIFT:	
	dpop r1
	mov TOS, r1, lsr TOS
	nxt
